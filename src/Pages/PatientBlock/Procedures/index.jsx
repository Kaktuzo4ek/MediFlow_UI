...
const Procedures = () => {
  ...
  const setEditModalAndData = (pId, sName, status, notes) => {
    setIsOpen(true);
  ...
  const setDataAndNavigateToViewInfo = (pId) => {
    ...
    navigate("../doctor/patient-procedures/view-info");
  };
                      ...
                      return (
                        ...
                        >
                          ...
                          <td>
                            ...
                            {item.patient.patronymic.slice(0, 1)}.
                          </td>
                          <td>
                            {item.doctor.surname} {item.doctor.name.slice(0, 1)}
                            . {item.doctor.patronymic.slice(0, 1)}.
                          </td>
                          <td>{item.category}</td>
