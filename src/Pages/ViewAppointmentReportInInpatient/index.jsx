...
import styles from './viewAppointInInpatient.module.scss';
import { useEffect } from 'react';
import classNames from 'classnames';
import { useState } from 'react';
import Navbar from '../../Components/Navbar';

const ViewAppointmentReportInInpatient = () => {
          ...
          <div className={styles.flexForReport}>
            <div className={styles.visitInfo}>
              ...
              <p>
                Лікар:{' '}
                <span>
                  {`${appointment.doctor.surname} ${appointment.doctor.name} ${appointment.doctor.patronymic}`}
                </span>
              </p>
              <p>
                Пацієнт:{' '}
...
export default ViewAppointmentReportInInpatient;
