...
const InpatientInteractions = () => {
  ...
  const [isDiagnosticReportActive, setIsDiagnosticReportActive] =
    useState(false);
          ...
          <div className={styles.navInteractions}>
            <button
              ...
              className={classNames(
                styles.navButtons,
                isAppointmentActive && styles.active,
              )}
            ...
            <button
              ...
              className={classNames(
                styles.navButtons,
                isReferralActive && styles.active,
              )}
              onClick={activeRefererral}
            >
              Направлення
            </button>
            <button
              ...
              className={classNames(
                styles.navButtons,
                isProcedureActive && styles.active,
              )}
              onClick={activeProcedure}
            >
              Процедури
            </button>
            <button
              ...
              className={classNames(
                styles.navButtons,
                isDiagnosticReportActive && styles.active,
              )}
              onClick={activeDiagnosticReport}
            >
              Діагностичні звіти
            </button>
          </div>
