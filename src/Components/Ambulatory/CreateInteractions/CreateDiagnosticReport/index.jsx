            ...
            <div className={styles.diagnosticReportBlock}>
                ...
                <form>
                    <div className={styles.form_group}>
                        <label htmlFor="select_services" className={styles.label}>Медична послуга <span>*</span></label>
                        <Select 
                    ...
                    <div className={styles.form_group}>
                        <label htmlFor="select_report_category" className={styles.label}>Категорія діагностичного звіту <span>*</span></label>
                        <Select 
                    ...
                    <div className={styles.form_group}>
                        <label htmlFor="select_execuatant" className={styles.label}>Виконавець діагностики <span>*</span></label>
                        <Select 
                    ...
                    <div className={styles.form_group}>
                        ...
                        <label htmlFor="select_interpreted" className={styles.label}>Працівник, що інтерпретував результати <span>*</span></label>
