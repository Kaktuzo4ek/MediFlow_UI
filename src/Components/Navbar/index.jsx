...
const Navbar = (props) => {
    ...
    return (
        <div className={classNames(styles.navbarWrapper, props.isActiveHamburger && styles.openNavbar)}>
            <div className={styles.navbarList}>
                <div className={styles.item}>
                    ...
                    <div className={styles.options}>
                        <h4>Заклад</h4>
                        <a onClick={() => {navigate('../doctor/hospital/doctors')}}>Медичні працівники</a>
                    </div>
                </div>
                <div className={styles.item}>
                    <hr/>
                ...
                <div className={styles.item}>
                    ...
                    <div className={styles.options}>
                        <h4>Пацієнти</h4>
                        <a onClick={() => {navigate('../doctor/search-patient')}}>Пошук пацієнта</a>
                    </div>
                </div>
            </div>
        </div>
