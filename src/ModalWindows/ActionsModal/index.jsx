...
const ActionsModal = props => {
    return(
            <div className={classNames(styles.modal_wrapper, `${props.isOpened ? styles.fadeIn : styles.fadeOut}`)} style={{...props.style}} id="modal">
                <div className={styles.modal_body}>
                    ...
                    <div className={styles.userAndNavFlex}>
                        ...
                        <div className={styles.navigation}>
                            <a href="medical-events/patient-episodes" className={styles.navItem} target='_blank' onClick={() => localStorage.setItem('patientId', props.item.patientId)}>Амбулаторні епізоди</a>
